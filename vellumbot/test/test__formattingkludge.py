...
from vellumbot.server._formattingkludge import IOneLine
...
class KludgeTest(unittest.TestCase):
    def test_oneLine(self):
        ...
        self.assertEqual(IOneLine(anaxim).format(), expected)
        ...
        self.assertEqual(IOneLine(mohrg).format(), expected)
