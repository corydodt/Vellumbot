...
class ReferenceTestCase(unittest.TestCase, util.DiffTestCaseMixin):
    ...
    def test_findExactOne(self):
        ...
        self.assertNoRxDiff(
                [re.escape('\037Fireball\017 Evocation || Level: Sorcerer/Wizard 3 || Casting Time: 1 standard action || VSM || Range: Long (400 ft. + 40 ft./level) || Area: 20-ft. -radius spread || Duration: Instantaneous || Save: Reflex half || \0021d6 damage per level, 20-ft. radius.\017 || http://www.d20srd.org/srd/spells/fireball.htm'),
                    ],
                ret,
    ...
    def test_findExactSpecialCharacters(self):
        ...
        self.assertNoRxDiff(
                [re.escape("\037Cat's Grace\017 Transmutation || Level: Bard 2, Druid 2, Ranger 2, Sorcerer/Wizard 2 || Casting Time: 1 standard action || VSM || Range: Touch || Target: Creature touched || Duration: 1 min./level || Save: Will negates (harmless) || \002Subject gains +4 to Dex for 1 min./level.\017 || http://www.d20srd.org/srd/spells/catsGrace.htm"),
                    ],
                ret,
                'expected (regex)', 'actual')
    ...
    def test_findAmbiguousExact(self):
        ...
        self.assertNoRxDiff(
                [re.escape('\037Cure Light Wounds\017 Conjuration (Healing) || Level: Bard 1, Cleric 1, Druid 1, Healing 1, Paladin 1, Ranger 2 || Casting Time: 1 standard action || VS || Range: Touch || Target: Creature touched || Duration: Instantaneous || Save: Will half (harmless); see text || \002Cures 1d8 damage +1/level (max +5).\017 || http://www.d20srd.org/srd/spells/cureLightWounds.htm'),
                    ],
                ret,
                'expected (regex)', 'actual')
